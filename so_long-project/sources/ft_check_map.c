...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/26 02:06:42 by mbaglami          #+#    #+#             */
/*   Updated: 2023/11/26 02:06:42 by mbaglami         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_rows(t_game *game)
{
	...
	i = 0;
	len = special_len(game, 0);
	while (i < game->map.rows)
	{
		cur_len = special_len(game, i);
...
The Map must be surrounded by walls!.", game);
			...
			ft_error_msg("Invalid Map. Not rectangular", game);
		i++;
	}
}
...
void	ft_verify_map_parameters(t_game *game)
{
	if (game->map.coins == 0)
		...
		ft_error_msg("Invalid Map. There is too many Exit.", game);
